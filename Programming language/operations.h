...
//-----------------------------------------------------------------------------
/* variables  */
/* сделать список функций и переменных - условно готово */
//-----------------------------------------------------------------------------
/* operators */
DEF_DIFF ("=",        1,  OP, 10, 1,
          {
...
DEF_DIFF ("break",    7,  OP, 10, 4,
          {
          })

DEF_DIFF ("continue", 8,  OP, 10, 4,
          {
          })
...
DEF_DIFF ("e",   2.718281828, CNST, 255, 4, ;)
